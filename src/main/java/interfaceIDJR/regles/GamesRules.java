...
public class GamesRules extends View {
	...
	private void placementWidgets() {
		...
		vbLeft.setBackground(new Background(new BackgroundImage(ImageManager.getImage("misc", "bg_paper2"), BackgroundRepeat.REPEAT, BackgroundRepeat.REPEAT, BackgroundPosition.DEFAULT, new BackgroundSize(1, 1, true, true, false, false))));
